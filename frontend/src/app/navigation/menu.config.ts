...
export const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: 'Outpatient',
        icon: 'doctor',
        permissions: ['outpatient.report.view'],
        children: [
          { label: 'Dashboard', icon: 'dashboard', route: '/outpatient/dashboard', permissions: ['outpatient.report.view'] },
          { label: 'Unified Queue', icon: 'list', route: '/outpatient/queue', permissions: ['opd.queue.manage'] },
          { label: 'Consultation', icon: 'doctor', route: '/outpatient/consultation', permissions: ['opd.consultation.start'] },
          { label: 'Reports', icon: 'reporting', route: '/outpatient/reports', permissions: ['outpatient.report.view'] },
        ],
      },
      {
        label: 'IPD',
  ...
  },
  {
    ...
    children: [
      { label: 'Dashboard', icon: 'dashboard', route: '/transport/dashboard', permissions: ['transport.dashboard.view'] },
      { label: 'Requests', icon: 'receipt', route: '/transport/requests', permissions: ['transport.view'] },
      { label: 'Ambulance Dispatch', icon: 'service', route: '/transport/dispatch', permissions: ['transport.dispatch'] },
      { label: 'Active Trips', icon: 'list', route: '/transport/trips', permissions: ['transport.view'] },
      { label: 'Vehicles', icon: 'list', route: '/transport/vehicles', permissions: ['transport.view'] },
      { label: 'Drivers', icon: 'users', route: '/transport/drivers', permissions: ['transport.view'] },
      { label: 'Schedule', icon: 'calendar', route: '/transport/schedule', permissions: ['transport.dispatch'] },
      { label: 'Maintenance', icon: 'settings', route: '/transport/maintenance', permissions: ['transport.maintenance.manage'] },
      { label: 'Fuel & Expenses', icon: 'accounting', route: '/transport/fuel', permissions: ['transport.fuel.manage'] },
      { label: 'Reports', icon: 'reporting', route: '/transport/reports', permissions: ['transport.report.view'] },
      { label: 'Settings', icon: 'settings', route: '/transport/settings', permissions: ['transport.settings.manage'] },
    ],
  },
  {
    label: 'Telemedicine',
    ...
    children: [
      { label: 'Dashboard', icon: 'dashboard', route: '/telemedicine/dashboard', permissions: ['telemedicine.view'] },
      { label: 'Online Appointments', icon: 'calendar', route: '/telemedicine/appointments', permissions: ['telemedicine.view'] },
      { label: 'Waiting Room', icon: 'list', route: '/telemedicine/waiting-room', permissions: ['telemedicine.queue.view'] },
      { label: 'Consultation', icon: 'doctor', route: '/telemedicine/consultation', permissions: ['telemedicine.consultation.start'] },
      { label: 'Completed Visits', icon: 'receipt', route: '/telemedicine/completed', permissions: ['telemedicine.view'] },
      { label: 'Payments', icon: 'billing', route: '/telemedicine/payments', permissions: ['telemedicine.payment.view'] },
      { label: 'Reports', icon: 'reporting', route: '/telemedicine/reports', permissions: ['telemedicine.report.view'] },
      { label: 'Settings', icon: 'settings', route: '/telemedicine/settings', permissions: ['telemedicine.settings.manage'] },
    ],
  },
    ],
  },
