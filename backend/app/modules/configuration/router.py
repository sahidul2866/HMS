...
@router.get("/workspace", response_model=ConfigurationWorkspaceRead, dependencies=[Depends(require_any_permissions("settings.configuration.manage", "opd.settings.manage"))])
...
@router.get("/profiles", response_model=list[ConfigurationProfileRead], dependencies=[Depends(require_any_permissions("settings.configuration.manage", "opd.settings.manage"))])
def list_profiles(
...
@router.post("/profiles", response_model=ConfigurationProfileRead, dependencies=[Depends(require_any_permissions("settings.configuration.manage", "opd.settings.manage"))])
...
@router.put("/profiles/{profile_id}", response_model=ConfigurationProfileRead, dependencies=[Depends(require_any_permissions("settings.configuration.manage", "opd.settings.manage"))])
...
@router.delete("/profiles/{profile_id}", dependencies=[Depends(require_any_permissions("settings.configuration.manage", "opd.settings.manage"))])
