...
from app.schemas.auth import PatientLoginResponse, PatientPortalAccountCreate, PatientPortalAccountRead, PatientRegisterRequest, TokenPair
from app.utils.phone import normalize_phone

PATIENT_PORTAL_PERMISSIONS = ["patient.portal.view"]
...
class PatientAuthService:
    ...
    def register(self, payload: PatientRegisterRequest, context: dict[str, str | None]) -> PatientLoginResponse:
        ...
        if not normalized_phone:
            raise AppException(status.HTTP_400_BAD_REQUEST, "invalid_phone", "A valid phone number is required")
