...
@router.get("/settings", response_model=StaffBotSettingsRead)
...
@router.post("/message", response_model=StaffBotResponse)
...
@router.post("/reset", response_model=StaffBotResponse)
